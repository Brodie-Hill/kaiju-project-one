...
public class TwoDimensionalAnimationScriptController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // increase velocityX if lleft is not pressed and velocityX < 0
        if (!leftPressed && velocityX < 0.0f)
        {
            velocityX += Time.deltaTime * deceleration;
        }

        //decrease veloctyX if right is not pressed and velocityX > 0
        ...
        {
            velocityZ -= Time.deltaTime * deceleration;
            // round to the curentMaxVelocity if within offset
